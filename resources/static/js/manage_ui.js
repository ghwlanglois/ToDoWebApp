...
async function initButtons() {
	$("body").prepend("<div style=\"position: relative; bottom: -34px;\" class=\"appDiv\">\
									        ...
									        <img src=\"resources/static/img/jg_logo.png\" alt=\"JG Logo\">\
								        </div>");
	$("body").find(".totalDiv").append("<div class=\"addListDiv\">\
											<button id=\"addListButton\" class=\"addList\">Add List</button>\
											<button id=\"viewAccountButton\" class=\"viewAccount\">Account</button>\
										</div>");
